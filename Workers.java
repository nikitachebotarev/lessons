...
// Задать внутри программы (захардкодить) массив работников. 
// У каждого есть имя, фамилия, должность. Программа должна вывести данные о работнике 
// по его имени и фамилии введенным в командную строку.
public class Main {
